...
# START with some local GPC stuff to load proper modules to run these scripts

source /scinet/gpc/Modules6/Modules/3.2.9/init/csh

module purge
module load intel
module load Xlibraries
module load extras
module load ImageMagick/6.6.7
module load udunits/2.1.11
...
set test_first_yr = $SPRD           # first year (must be >= 1)
set test_nyrs     = $NPRD           # number of yrs (must be >= 1)
...
# GPC machine
setenv DIAG_HOME /project/c/ccsm/model_diagnostics/atm/cam/amwg_diag5.6 
