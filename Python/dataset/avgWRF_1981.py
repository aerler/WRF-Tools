...
wrfdate = '1981-\d\d' # use '\d' for any number and [1-3,45] for ranges
# output files and folders
meanfile = 'wrfsrfc_d%02i_monthly_1981.nc' # %02i is for the domain number
climfile = 'wrfsrfc_d%02i_clim_1981.nc' # %02i is for the domain number
# variables
